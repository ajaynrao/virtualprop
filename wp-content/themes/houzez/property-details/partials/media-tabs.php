...
if($top_area == 'v2') { ?>
	<div class="tab-pane <?php echo esc_attr($gallery_active); ?>" id="pills-gallery" role="tabpanel" aria-labelledby="pills-gallery-tab" style="background-image: url(<?php echo esc_url($featured_image_url); ?>);">
		...
		<a class="property-banner-trigger zzz" data-toggle="modal" data-target="#property-lightbox" href="#"></a>
	</div>
...
<?php } else { ?>
	...
	<div class="tab-pane <?php echo esc_attr($gallery_active); ?>" id="pills-gallery" role="tabpanel" aria-labelledby="pills-gallery-tab" style="background-image: url(<?php echo esc_url($featured_image_url); ?>);">
		...
		<a class="property-banner-trigger ccc" data-toggle="modal" data-target="#property-lightbox" href="#"></a>
	</div>
