...
wp_register_script('vimeo-api', 'https://player.vimeo.com/api/player.js', true);
wp_enqueue_script('vimeo-api');
// wp_register_script('jquery-mobile', 'http://code.jquery.com/mobile/1.4.5/jquery.mobile-1.4.5.min.js', true);
