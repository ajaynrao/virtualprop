            ...
            <div class="property-banner">
                ...
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane show active" id="pills-gallery" role="tabpanel" aria-labelledby="pills-gallery-tab" style="background-image: url(<?php echo esc_url($featured_image_url[0]); ?>);">
                        ...
                        <a class="property-banner-trigger aa" data-toggle="modal" data-target="#property-lightbox" href="#"></a>
                    </div>
...
Plugin::instance()->widgets_manager->register_widget_type( new Property_Toparea );