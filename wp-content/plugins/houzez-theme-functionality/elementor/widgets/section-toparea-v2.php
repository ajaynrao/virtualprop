...
class Property_Toparea_v2 extends Widget_Base {


	public function get_name() {
		return 'houzez-property-toparea-v2';
	}

	public function get_title() {
		return __( 'Section Top Area v2', 'houzez-theme-functionality' );
	}
	...
	public function get_keywords() {
		return ['property', 'toparea v2', 'houzez', 'gallery' ];
	}
	...
	protected function render() {
        ...
        <div class="property-wrap property-detail-v2">
                ...
                <div class="property-banner">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="tab-pane show active" id="pills-gallery" role="tabpanel" aria-labelledby="pills-gallery-tab" style="background-image: url(<?php echo esc_url($featured_image_url[0]); ?>);">
                            ...
                            <?php htf_get_template_part('elementor/template-part/single-property/property-title', 'v2'); ?>

                            <a class="property-banner-trigger bb" data-toggle="modal" data-target="#property-lightbox" href="#"></a>
                        </div>
...
Plugin::instance()->widgets_manager->register_widget_type( new Property_Toparea_v2 );